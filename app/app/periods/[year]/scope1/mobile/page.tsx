  ...
  return (
    <div className="p-4 lg:p-8">
      <div className="mb-6">
        ...
        <h1 className="text-xl font-semibold text-[#0f0f10]">{t('Poraba goriva – vozila', 'Vehicle fuel consumption')}</h1>
      </div>
                  ...
                  <tr key={v.id} className={`hover:bg-[#f9f9f9] transition-colors ${i !== 0 ? 'border-t border-[#ececec]' : ''}`}>
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 bg-[#efefef] rounded-lg flex items-center justify-center shrink-0 text-base leading-none">
