  ...
  return (
    <div className="p-4 lg:p-8">
      <div className="mb-6">
        ...
        <p className="text-sm text-[#455451] mt-0.5">{t('Direktne emisije iz izhajanja industrijskih plinov', 'Direct emissions from industrial gas leakage')}</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-white border border-[#e2e2e4] rounded-xl py-14 text-center">
          ...
          <p className="text-sm text-[#455451] mb-1">{t('Ni opreme z industrijskimi plini.', 'No industrial gas equipment.')}</p>
          <p className="text-xs text-[#455451]">{t('Označite opremo kot "Uporablja industrijske pline" v razdelku Oprema.', 'Mark equipment as "Uses industrial gases" in the Equipment section.')}</p>
        </div>
      ) : (
          ...
          <table className="w-full">
            <thead className="bg-[#fafafc]">
              <tr className="border-b border-[#e2e2e4] bg-[#f9f9f9]/50">
                ...
                <th className="text-left text-xs font-semibold text-[#455451] uppercase tracking-wider px-5 py-3">{t('Plin', 'Gas')}</th>
                <th className="text-left text-xs font-semibold text-[#455451] uppercase tracking-wider px-5 py-3">{t('Količina', 'Quantity')} (kg)</th>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 z-10 bg-white border-b border-[#e2e2e4] px-6 py-5 flex items-center justify-between rounded-t-2xl">
              <div>
                <h2 className="text-lg font-bold text-[#031f18]">{entriesMap[activeItem.id] ? t('Uredi vnos', 'Edit entry') : t('Dodaj plin', 'Add gas')}</h2>
            ...
            <div className="p-6 space-y-4">
              <div>
                <label className="block text-sm font-medium text-[#031f18] mb-1.5">{t('Vrsta plina', 'Gas type')}</label>
              ...
              <div>
                <label className="block text-sm font-medium text-[#031f18] mb-1.5">{t('Letna količina', 'Annual quantity')} (kg) <span className="text-red-400">*</span></label>
