  ...
  return (
    <div className="p-4 lg:p-8">
      <div className="mb-6">
        ...
        <p className="text-sm text-[#455451] mt-0.5">{t('Direktne emisije iz ogrevanja in procesov', 'Direct emissions from heating and processes')}</p>
      </div>
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 z-10 bg-white border-b border-[#e2e2e4] px-6 py-5 flex items-center justify-between rounded-t-2xl">
              <div>
                ...
                <p className="text-xs text-[#455451] mt-0.5">{activeLocation.name} · Scope 1 · {year}</p>
              </div>
