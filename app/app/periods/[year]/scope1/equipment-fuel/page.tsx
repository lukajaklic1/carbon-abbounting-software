  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {loading ? (
        ...
        <EmptyState iconNode={<IconEngine size={32} />} title={t('Ni opreme z gorivom', 'No fuel-using equipment')} subtitle={t('Dodajte opremo z vklopljenim gorivom.', 'Add equipment with fuel enabled.')} />
      ) : (
        <>
