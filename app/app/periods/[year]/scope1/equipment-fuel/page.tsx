  ...
  return (
    <div className="p-4 lg:p-8">
      <div className="mb-6">
        ...
        <p className="text-sm text-[#455451] mt-0.5">{t('Direktne emisije iz zgorevanja goriva v opremi', 'Direct emissions from fuel combustion in equipment')}</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-white border border-[#e2e2e4] rounded-xl py-14 text-center">
          ...
          <p className="text-sm text-[#455451] mb-1">{t('Ni opreme z gorivom.', 'No fuel-using equipment.')}</p>
          <p className="text-xs text-[#455451]">{t('Označite opremo kot "Uporablja gorivo" v razdelku Oprema.', 'Mark equipment as "Uses fuel" in the Equipment section.')}</p>
        </div>
      ) : (
