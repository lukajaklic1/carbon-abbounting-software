          ...
          <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-md max-h-[80vh] flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto px-2 py-3 space-y-1.5">
              {(() => {
                ...
                if (modalList.length === 0) return <div className="mx-4 my-3 border border-gray-200 bg-white rounded-xl flex flex-col items-center justify-center py-10 px-6 text-center"><Flame className="h-8 w-8 mb-3" style={{ color: '#e4e4e8' }} /><p className="text-sm font-medium text-gray-900">{t('Ni lokacij z daljinsko toploto', 'No locations with district heat')}</p><p className="text-xs text-gray-400 mt-1 max-w-[200px]">{t('Dodajte lokacijo, ki uporablja daljinsko toploto.', 'Add a location that uses district heat.')}</p></div>
