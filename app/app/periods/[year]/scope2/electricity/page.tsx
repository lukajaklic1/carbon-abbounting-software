  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between px-6 border-b border-gray-200 h-[57px] shrink-0">
        <div>
          <h1 className="text-base font-semibold text-gray-900">{t('Električna energija – lokacije', 'Electricity – locations')}</h1>
      </div>
      ...
      {loading ? (
        ...
        <EmptyState
            ...
            subtitle={t('Dodajte lokacijo z vklopljeno elektriko.', 'Add a location with electricity enabled.')}
          />
      ) : (
        <>
