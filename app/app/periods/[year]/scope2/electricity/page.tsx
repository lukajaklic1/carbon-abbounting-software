  ...
  return (
    <div className="p-4 lg:p-8">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-[#031f18]">{t('Električna energija – lokacije', 'Electricity – locations')}</h1>
        <p className="text-sm text-[#767676] mt-0.5">{t('Posredne emisije iz porabe električne energije', 'Indirect emissions from electricity consumption')}</p>
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              <div>
                <label className="block text-sm font-medium text-[#031f18] mb-1.5">{t('Letna poraba', 'Annual consumption')} (kWh) <span className="text-red-400">*</span></label>
              ...
              <div>
                <label className="block text-sm font-medium text-[#031f18] mb-1.5">{t('Država / faktor', 'Country / factor')}</label>
