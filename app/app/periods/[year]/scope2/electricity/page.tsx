  ...
  return (
    <div className="p-4 lg:p-8">
      <div className="mb-6">
        ...
        <p className="text-sm text-[#455451] mt-0.5">{t('Posredne emisije iz porabe električne energije', 'Indirect emissions from electricity consumption')}</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-white border border-[#e2e2e4] rounded-xl py-14 text-center">
          ...
          <p className="text-sm text-[#455451] mb-1">{t('Ni aktivnih lokacij.', 'No active locations.')}</p>
          <p className="text-xs text-[#455451]">{t('Najprej dodajte lokacije v razdelku Lokacije.', 'First add locations in the Locations section.')}</p>
        </div>
      ) : (
