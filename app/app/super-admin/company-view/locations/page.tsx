    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between px-6 border-b border-gray-200 h-[57px] shrink-0">
        <div className="flex items-baseline gap-3 min-w-0">
          <h1 className="text-base font-semibold text-gray-900 shrink-0">Lokacije</h1>
      ...
      <div className="flex-1 overflow-auto">
        {loading ? (
          ...
          <div className="p-12 text-center text-sm text-gray-300">Ni lokacij.</div>
        ) : (
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200 bg-gray-50">
                  ...
                  <th className="text-left text-xs font-medium text-gray-500 px-5 py-3">Naslov</th>
                    ...
                    <td className="px-5 py-3.5">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0" style={{backgroundColor:'#e5eeff',border:'1px solid #d6e5ff'}}>
                          <MapPin className="h-3.5 w-3.5" style={{color:'#215bcf'}} />
                        </div>
                        <span className="text-sm font-semibold text-gray-900">{r.name}</span>
                      </div>
                    </td>
                    <td className="px-5 py-3.5 text-sm text-gray-700">{r.address ?? '—'}</td>
                    <td className="px-5 py-3.5">
