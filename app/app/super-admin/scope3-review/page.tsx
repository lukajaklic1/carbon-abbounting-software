...
export default function Scope3ReviewPage() {
  ...
  return (
    <div className="p-4 lg:p-8 max-w-5xl">
      <div className="mb-6">
        <p className="text-xs font-semibold text-[#455451] uppercase tracking-widest mb-1">Scope 3 · {selectedOrg.name}</p>
        <h1 className="text-2xl font-bold text-[#031f18]">Scope 3 — Pregled oddanih datotek</h1>
        <p className="text-sm text-[#455451] mt-0.5">Preglejte oddane podatke in vnesite izračunane emisije.</p>
      </div>
            ...
            <div key={sub.id} className={cn('px-5 py-4', i !== 0 && 'border-t border-[#e2e2e4]')}>
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-[#455451] mt-0.5">Leto {sub.period_year}</p>
                </div>
